...
export const EVENTS: EventDefinition[] = [
  ...
  // intl_first_stand / intl_msi / intl_worlds ya no viven acá: cada torneo
  // internacional (y cada clasificación a playoffs) ahora dispara un "gran
  // momento" específico del rol del jugador — ver content/bigMoments.ts y
  // /carrera/partido. Reemplazaban un placeholder genérico de 4 opciones
  // repetidas, así que no hay contenido que migrar, solo se eliminan.
];
